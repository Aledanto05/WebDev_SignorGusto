// Signor Gusto Custom JavaScript — v2.0
// Mantiene tutto il codice originale + aggiunge hamburger, tabs e modal

document.addEventListener('DOMContentLoaded', function () {

    /* ========================================================
       ORIGINALE — SCROLL ANIMATIONS
    ======================================================== */
    ...
    const animatedElements = document.querySelectorAll('.service-card, .hero-content, .feature-item');
    ...
    /* ========================================================
       ORIGINALE — NAVBAR SCROLL EFFECT
    ======================================================== */
    ...
    stabs.forEach(function (tab) {
        tab.addEventListener('click', function () {
            ...
            // Attiva il tab cliccato e il panel corrispondente
